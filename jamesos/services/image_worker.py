...
def structured_error(exc: Exception, job_id: str = "", workflow_path: str = "") -> dict[str, Any]:
    return {
        ...
        "prompt_validation_details": getattr(exc, "prompt_validation_details", None),
...
def health() -> dict[str, Any]:
    ...
    return {
        ...
        "routes": [
            ...
            "POST /image-worker/jobs/{job_id}/validate-upscale-model",
            "GET /image-worker/upscale-models",
