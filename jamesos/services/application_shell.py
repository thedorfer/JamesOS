...
VIEWS={"dashboard","agency.home","agency.agent","agency.book-scout","commerce.new","commerce.loading","commerce.review","commerce.diagnostics","commerce.published","jobs.list","jobs.detail","profiles","settings","diagnostics","admin.home"}
VIEW_TITLES={"dashboard":"Home","agency.home":"The Agency","agency.agent":"Agent details","agency.book-scout":"Book Opportunity Scout","admin.home":"Admin","commerce.new":"Product Studio","commerce.loading":"Product Studio","commerce.review":"Product Studio review","commerce.diagnostics":"Product Studio diagnostics","commerce.published":"Published product","jobs.list":"Jobs","jobs.detail":"Job detail","profiles":"Profiles","settings":"Settings","diagnostics":"Diagnostics"}
