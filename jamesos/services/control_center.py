...
def gpu_comfyui_readiness() -> dict[str, Any]:
    ...
    last_artifact = _safe_call({}, image_worker.last_design_artifact)
    return {
        ...
        "default_transparent_print_design_workflow_path": default_templates.get("default_transparent_print_design_workflow_path", ""),
        "comfyui_open_workflow_ignored": True,
        "last_design_artifact_path": last_artifact.get("final_image_path") or last_artifact.get("source_image_path") or "",
        "last_design_artifact_status": last_artifact.get("output_status") or last_artifact.get("quality_stage") or "",
        "background_removal_required": bool(last_artifact.get("background_removal_required", False)),
        "manual_upload_ready": bool(last_artifact.get("manual_upload_ready", False)),
        "current_default_pod_provider": str(last_artifact.get("provider_target") or "printify"),
...
def integrations() -> dict[str, Any]:
    ...
    rows = {
        "comfyui": {
            ...
            "default_transparent_print_design_workflow_path": comfyui["default_transparent_print_design_workflow_path"],
            "comfyui_open_workflow_ignored": True,
            "last_design_artifact_path": comfyui["last_design_artifact_path"],
            "last_design_artifact_status": comfyui["last_design_artifact_status"],
            "background_removal_required": comfyui["background_removal_required"],
            "manual_upload_ready": comfyui["manual_upload_ready"],
            "current_default_pod_provider": comfyui["current_default_pod_provider"],
    ...
    return {
        ...
        "services": {
            ...
            "workflow_manager": {
                ...
                "default_transparent_print_design_workflow_path": _safe_call({"default_transparent_print_design_workflow_path": ""}, workflow_manager.initialize_default_workflow_templates).get("default_transparent_print_design_workflow_path", ""),
                "comfyui_open_workflow_ignored": True,
                "last_design_artifact_path": (image.get("last_design_artifact") or {}).get("final_image_path") or (image.get("last_design_artifact") or {}).get("source_image_path") or "",
                "last_design_artifact_status": (image.get("last_design_artifact") or {}).get("output_status") or (image.get("last_design_artifact") or {}).get("quality_stage") or "",
                "background_removal_required": bool((image.get("last_design_artifact") or {}).get("background_removal_required", False)),
                "manual_upload_ready": bool((image.get("last_design_artifact") or {}).get("manual_upload_ready", False)),
                "current_default_pod_provider": str((image.get("last_design_artifact") or {}).get("provider_target") or "printify"),
