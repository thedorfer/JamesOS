...
from jamesos.services.relationship_engine import build_internal_db, build_relationship_index, get_entity_relationships, write_relationship_report
...
def build_server() -> FastMCP:
    ...
    mcp.tool()(get_entity_relationships, write_relationship_report)
