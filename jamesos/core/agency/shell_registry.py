...
class ShellAgencyRegistry:
    ...
    def _state(self)->dict[str,Any]:
        ...
        for agent_id,manifest in MANIFESTS.items():value["agents"].setdefault(agent_id,{"installed":agent_id!="jamesos.book-opportunity-scout","enabled_state":"enabled" if agent_id!="jamesos.book-opportunity-scout" else "disabled","installed_version":manifest["version"],"configuration":{},"permission_grants":list(manifest["permissions"])})
        return value
