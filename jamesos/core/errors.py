...
ERROR_CODES: Mapping[str, ErrorCodeSpec] = MappingProxyType({
    ...
    "PRINTIFY_AUTHENTICATION_FAILED": ErrorCodeSpec("printify", "error", False, "Printify authentication could not be completed."),
    "PRINTIFY_UPLOAD_FAILED": ErrorCodeSpec("printify", "error", False, "The artwork could not be uploaded to Printify."),
    "PRINTIFY_PRODUCT_CREATE_FAILED": ErrorCodeSpec("printify", "error", False, "The Printify product draft could not be created."),
    "PRINTIFY_PRODUCT_UPDATE_FAILED": ErrorCodeSpec("printify", "error", False, "The Printify product draft could not be updated."),
    "PRINTIFY_REQUEST_FAILED": ErrorCodeSpec("printify", "error", False, "The Printify request could not be completed."),
    "PUBLICATION_EXECUTOR_NOT_CONFIGURED": ErrorCodeSpec("configuration", "error", False, "Publication executor is not configured."),
    "PUBLICATION_APPROVAL_INVALID": ErrorCodeSpec("approval", "warning", False, "Publication approval is missing or stale."),
    "PUBLICATION_STATE_CONFLICT": ErrorCodeSpec("state", "warning", False, "Publication state conflicts with the approved proposal."),
    "PUBLICATION_PROVIDER_UPDATE_FAILED": ErrorCodeSpec("external_dependency", "error", False, "Provider metadata update failed."),
    "PUBLICATION_PROVIDER_VERIFICATION_FAILED": ErrorCodeSpec("external_dependency", "error", False, "Provider verification failed."),
    "PUBLICATION_SUBMISSION_FAILED": ErrorCodeSpec("external_dependency", "error", False, "Publication submission failed."),
    "PUBLICATION_RESULT_UNCERTAIN": ErrorCodeSpec("external_dependency", "warning", False, "Publication result is uncertain."),
    "MARKETPLACE_LISTING_NOT_RESOLVED": ErrorCodeSpec("external_dependency", "error", False, "Marketplace listing could not be resolved."),
    "MARKETPLACE_FINAL_STATE_MISMATCH": ErrorCodeSpec("external_dependency", "error", False, "Marketplace final state does not match the approved proposal."),
    "MIGRATION_PROFILE_NOT_FOUND": ErrorCodeSpec("configuration", "error", False, "The requested migration profile was not found."),
    "MIGRATION_PROFILE_INVALID": ErrorCodeSpec("configuration", "error", False, "The requested migration profile is invalid."),
    "MIGRATION_PROFILE_CONFLICT": ErrorCodeSpec("state", "warning", False, "The migration profile conflicts with approved evidence."),
    "MIGRATION_PRINTIFY_SHOP_CONFLICT": ErrorCodeSpec("state", "warning", False, "The Printify shop binding conflicts with approved evidence."),
    "MIGRATION_ETSY_SHOP_CONFLICT": ErrorCodeSpec("state", "warning", False, "The Etsy shop binding conflicts with existing private evidence."),
    "MIGRATION_LEGACY_EVIDENCE_MISSING": ErrorCodeSpec("artifact", "error", False, "Required legacy migration evidence is missing."),
    "MIGRATION_LEGACY_PROFILE_REQUIRED": ErrorCodeSpec("state", "warning", False, "An exact legacy profile identity is required."),
    "MIGRATION_LEGACY_PROFILE_AMBIGUOUS": ErrorCodeSpec("state", "warning", False, "Legacy profile identity evidence is ambiguous."),
    "MIGRATION_PROPOSAL_INVALID": ErrorCodeSpec("artifact", "error", False, "The migration proposal evidence is invalid."),
    "MIGRATION_APPROVAL_INVALID": ErrorCodeSpec("approval", "warning", False, "The migration approval evidence is invalid."),
    "MIGRATION_STATE_CONFLICT": ErrorCodeSpec("state", "warning", False, "The job state prevents compatibility migration."),
    "MIGRATION_PUBLICATION_EXISTS": ErrorCodeSpec("state", "warning", False, "Publication execution evidence already exists."),
    "MIGRATION_PROTECTED_PRODUCT": ErrorCodeSpec("state", "warning", False, "The migration targets a missing or protected product."),
    "MIGRATION_CONFIRMATION_REQUIRED": ErrorCodeSpec("approval", "warning", False, "Explicit migration confirmation is required."),
    "MIGRATION_BINDING_CONFLICT": ErrorCodeSpec("state", "warning", False, "A conflicting execution binding already exists."),
    "MIGRATION_DIGEST_INVALID": ErrorCodeSpec("artifact", "error", False, "The private migration binding digest is invalid."),
    "BLOCKED_ETSY_SHOP_BINDING_REQUIRED": ErrorCodeSpec("configuration", "warning", False, "An exact private Etsy shop binding is required."),
    "BLOCKED_PROFILE_IDENTITY_MISMATCH": ErrorCodeSpec("state", "warning", False, "The selected profile differs from the legacy private profile identity."),
    ...
    "REVISION_NOTE_INVALID": ErrorCodeSpec("validation", "warning", False, "The revision note is invalid."),
    "REVISION_STAGE_INVALID": ErrorCodeSpec("state", "warning", False, "The job is not ready for a revision request."),
