...
UNITYSTITICHES_PROFILE={
    ...
    "configuration":{"printify_shop_id":9437076,"sales_channel":"etsy","default_currency":"USD","human_review_location":"etsy","publish_policy":"publish_then_inactivate","default_mockup_policy":"all_current_mockups","pricing_policy_reference":"unitystitches-pricing-v1","listing_policy_reference":"unitystitches-listing-v1"},
